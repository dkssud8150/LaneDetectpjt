...
//		int offset = win_y_low - 4;
	...
	line(roi, Point(lx1, ly1), Point(lx2, ly2), Scalar(50, 100, 255), 1);
	line(roi, Point(rx1, ry1), Point(rx2, ry2), Scalar(50, 100, 255), 1);
	line(roi, Point(mx1, my1), Point(mx2, my2), Scalar(0, 0, 200), 3);
